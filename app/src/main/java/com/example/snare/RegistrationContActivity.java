...
public class RegistrationContActivity extends AppCompatActivity {
    ...
    public void Save(View view) {
        if(imageUri != null && !username.getText().toString().equals("") && !dob.getText().toString().equals("")) {
            uploadToFirebase(imageUri, username, dob);
        } else {
            Toast.makeText(this, "Please Enter Your information", Toast.LENGTH_SHORT).show();
        }
    }

    private void uploadToFirebase(Uri imageUri, TextView username, TextView dob) {
